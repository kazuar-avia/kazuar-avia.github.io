...
const ICAO_COUNTRY = {
  // Точкові винятки / shared prefixes
  WN00: {cc:"us", name:"США"},
  LYPG: {cc:"me", name:"Чорногорія"},
  LYTV: {cc:"me", name:"Чорногорія"},
  LYBR: {cc:"me", name:"Чорногорія"},
  GC: {cc:"es", name:"Іспанія"},
  GE: {cc:"es", name:"Іспанія"},
  GM: {cc:"ma", name:"Марокко"},
  GS: {cc:"eh", name:"Західна Сахара"},
  GQ: {cc:"mr", name:"Мавританія"},
  LF: {cc:"fr", name:"Франція"},
  NT: {cc:"pf", name:"Французька Полінезія"},
  SO: {cc:"gf", name:"Французька Гвіана"},

  // Europe
  BG: {cc:"gl", name:"Гренландія"},
  BI: {cc:"is", name:"Ісландія"},
  EB: {cc:"be", name:"Бельгія"},
  ED: {cc:"de", name:"Німеччина"},
  EE: {cc:"ee", name:"Естонія"},
  EF: {cc:"fi", name:"Фінляндія"},
  EG: {cc:"gb", name:"Велика Британія"},
  EH: {cc:"nl", name:"Нідерланди"},
  EI: {cc:"ie", name:"Ірландія"},
  EK: {cc:"dk", name:"Данія"},
  EL: {cc:"lu", name:"Люксембург"},
  EN: {cc:"no", name:"Норвегія"},
  EP: {cc:"pl", name:"Польща"},
  ES: {cc:"se", name:"Швеція"},
  ET: {cc:"de", name:"Німеччина"},
  EV: {cc:"lv", name:"Латвія"},
  EY: {cc:"lt", name:"Литва"},
  LA: {cc:"al", name:"Албанія"},
  LB: {cc:"bg", name:"Болгарія"},
  LC: {cc:"cy", name:"Кіпр"},
  LD: {cc:"hr", name:"Хорватія"},
  LE: {cc:"es", name:"Іспанія"},
  LG: {cc:"gr", name:"Греція"},
  LH: {cc:"hu", name:"Угорщина"},
  LI: {cc:"it", name:"Італія"},
  LJ: {cc:"si", name:"Словенія"},
  LK: {cc:"cz", name:"Чехія"},
  LL: {cc:"il", name:"Ізраїль"},
  LM: {cc:"mt", name:"Мальта"},
  LO: {cc:"at", name:"Австрія"},
  LP: {cc:"pt", name:"Португалія"},
  LQ: {cc:"ba", name:"Боснія і Герцеговина"},
  LR: {cc:"ro", name:"Румунія"},
  LS: {cc:"ch", name:"Швейцарія"},
  LT: {cc:"tr", name:"Туреччина"},
  LU: {cc:"md", name:"Молдова"},
  LW: {cc:"mk", name:"Північна Македонія"},
  LY: {cc:"rs", name:"Сербія"},
  LZ: {cc:"sk", name:"Словаччина"},
  UK: {cc:"ua", name:"Україна"},
  UM: {cc:"by", name:"Білорусь"},
  UR: {cc:"ua", name:"Україна"},

  // North America / Central America / Caribbean
  C: {cc:"ca", name:"Канада"},
  CY: {cc:"ca", name:"Канада"},
  ...
  PJ: {cc:"us", name:"США"},
  PW: {cc:"us", name:"США"},
  TA: {cc:"ag", name:"Антигуа і Барбуда"},
  TB: {cc:"bb", name:"Барбадос"},
  TD: {cc:"dm", name:"Домініка"},
  TF: {cc:"is", name:"Ісландія"},
  TG: {cc:"gd", name:"Гренада"},
  TI: {cc:"vi", name:"Американські Віргінські Острови"},
  TJ: {cc:"pr", name:"Пуерто-Рико"},
  TK: {cc:"kn", name:"Сент-Кіттс і Невіс"},
  TL: {cc:"lc", name:"Сент-Люсія"},
  TNCA: {cc:"aw", name:"Аруба"},
  TNCB: {cc:"bq", name:"Карибські Нідерланди"},
  TNCC: {cc:"cw", name:"Кюрасао"},
  TNCE: {cc:"bq", name:"Карибські Нідерланди"},
  TNCM: {cc:"sx", name:"Сінт-Мартен"},
  TNCS: {cc:"bq", name:"Карибські Нідерланди"},
  TQ: {cc:"ai", name:"Ангілья"},
  TR: {cc:"ms", name:"Монтсеррат"},
  TT: {cc:"tt", name:"Тринідад і Тобаго"},
  TU: {cc:"vg", name:"Британські Віргінські Острови"},
  TV: {cc:"vc", name:"Сент-Вінсент і Гренадини"},
  TX: {cc:"bm", name:"Бермуди"},
  MB: {cc:"tc", name:"Теркс і Кайкос"},
  MD: {cc:"do", name:"Домініканська Республіка"},
  MG: {cc:"gt", name:"Гватемала"},
  MH: {cc:"hn", name:"Гондурас"},
  MK: {cc:"jm", name:"Ямайка"},
  MM: {cc:"mx", name:"Мексика"},
  MN: {cc:"ni", name:"Нікарагуа"},
  MP: {cc:"pa", name:"Панама"},
  MR: {cc:"cr", name:"Коста-Рика"},
  MS: {cc:"sv", name:"Сальвадор"},
  MT: {cc:"ht", name:"Гаїті"},
  MU: {cc:"cu", name:"Куба"},
  MW: {cc:"ky", name:"Кайманові Острови"},
  MY: {cc:"bs", name:"Багамські Острови"},
  MZ: {cc:"bz", name:"Беліз"},

  // South America
  SA: {cc:"ar", name:"Аргентина"},
  SB: {cc:"br", name:"Бразилія"},
  SC: {cc:"cl", name:"Чилі"},
  SD: {cc:"br", name:"Бразилія"},
  SE: {cc:"ec", name:"Еквадор"},
  SF: {cc:"fk", name:"Фолклендські Острови"},
  SG: {cc:"py", name:"Парагвай"},
  SI: {cc:"br", name:"Бразилія"},
  SJ: {cc:"br", name:"Бразилія"},
  SK: {cc:"co", name:"Колумбія"},
  SL: {cc:"bo", name:"Болівія"},
  SM: {cc:"sr", name:"Суринам"},
  SN: {cc:"br", name:"Бразилія"},
  SP: {cc:"pe", name:"Перу"},
  SS: {cc:"br", name:"Бразилія"},
  SU: {cc:"uy", name:"Уругвай"},
  SV: {cc:"ve", name:"Венесуела"},
  SW: {cc:"br", name:"Бразилія"},
  SY: {cc:"gy", name:"Гаяна"},

  // Africa
  DA: {cc:"dz", name:"Алжир"},
  DB: {cc:"bj", name:"Бенін"},
  DF: {cc:"bf", name:"Буркіна-Фасо"},
  DG: {cc:"gh", name:"Гана"},
  DI: {cc:"ci", name:"Кот-дʼІвуар"},
  DN: {cc:"ng", name:"Нігерія"},
  DR: {cc:"ne", name:"Нігер"},
  DT: {cc:"tn", name:"Туніс"},
  DX: {cc:"tg", name:"Того"},
  FA: {cc:"za", name:"ПАР"},
  FB: {cc:"bw", name:"Ботсвана"},
  FC: {cc:"cg", name:"Республіка Конго"},
  FD: {cc:"sz", name:"Есватіні"},
  FE: {cc:"cf", name:"Центральноафриканська Республіка"},
  FG: {cc:"gq", name:"Екваторіальна Гвінея"},
  FH: {cc:"sh", name:"Острів Святої Єлени"},
  FI: {cc:"mu", name:"Маврикій"},
  FJ: {cc:"io", name:"Британська територія в Індійському океані"},
  FK: {cc:"cm", name:"Камерун"},
  FL: {cc:"zm", name:"Замбія"},
  FM: {cc:"mg", name:"Мадагаскар"},
  FN: {cc:"ao", name:"Ангола"},
  FO: {cc:"ga", name:"Габон"},
  FP: {cc:"st", name:"Сан-Томе і Принсіпі"},
  FQ: {cc:"mz", name:"Мозамбік"},
  FS: {cc:"sc", name:"Сейшели"},
  FT: {cc:"td", name:"Чад"},
  FV: {cc:"zw", name:"Зімбабве"},
  FW: {cc:"mw", name:"Малаві"},
  FX: {cc:"ls", name:"Лесото"},
  FY: {cc:"na", name:"Намібія"},
  GA: {cc:"ml", name:"Малі"},
  GB: {cc:"gm", name:"Гамбія"},
  GF: {cc:"sl", name:"Сьєрра-Леоне"},
  GG: {cc:"gw", name:"Гвінея-Бісау"},
  GL: {cc:"lr", name:"Ліберія"},
  GO: {cc:"sn", name:"Сенегал"},
  GU: {cc:"gn", name:"Гвінея"},
  GV: {cc:"cv", name:"Кабо-Верде"},
  HA: {cc:"et", name:"Ефіопія"},
  HB: {cc:"bi", name:"Бурунді"},
  HC: {cc:"so", name:"Сомалі"},
  HD: {cc:"dj", name:"Джибуті"},
  HE: {cc:"eg", name:"Єгипет"},
  HH: {cc:"er", name:"Еритрея"},
  HK: {cc:"ke", name:"Кенія"},
  HL: {cc:"ly", name:"Лівія"},
  HR: {cc:"rw", name:"Руанда"},
  HS: {cc:"sd", name:"Судан"},
  HT: {cc:"tz", name:"Танзанія"},
  HU: {cc:"ug", name:"Уганда"},

  // Middle East / Western & Central Asia
  OA: {cc:"af", name:"Афганістан"},
  OB: {cc:"bh", name:"Бахрейн"},
  OE: {cc:"sa", name:"Саудівська Аравія"},
  OI: {cc:"ir", name:"Іран"},
  OJ: {cc:"jo", name:"Йорданія"},
  OK: {cc:"kw", name:"Кувейт"},
  OL: {cc:"lb", name:"Ліван"},
  OM: {cc:"ae", name:"ОАЕ"},
  OO: {cc:"om", name:"Оман"},
  OP: {cc:"pk", name:"Пакистан"},
  OR: {cc:"iq", name:"Ірак"},
  OS: {cc:"sy", name:"Сирія"},
  OT: {cc:"qa", name:"Катар"},
  OY: {cc:"ye", name:"Ємен"},
  UA: {cc:"kz", name:"Казахстан"},
  UB: {cc:"az", name:"Азербайджан"},
  UC: {cc:"kg", name:"Киргизстан"},
  UD: {cc:"am", name:"Вірменія"},
  UG: {cc:"ge", name:"Грузія"},
  UTA: {cc:"tm", name:"Туркменістан"},
  UTB: {cc:"tm", name:"Туркменістан"},
  UTD: {cc:"tj", name:"Таджикистан"},
  UTK: {cc:"uz", name:"Узбекистан"},
  UTN: {cc:"uz", name:"Узбекистан"},
  UTS: {cc:"uz", name:"Узбекистан"},
  UTT: {cc:"uz", name:"Узбекистан"},
  UT: {cc:"uz", name:"Узбекистан"},

  // South / East / Southeast Asia
  RC: {cc:"tw", name:"Тайвань"},
  RJ: {cc:"jp", name:"Японія"},
  RK: {cc:"kr", name:"Південна Корея"},
  RO: {cc:"jp", name:"Японія"},
  RP: {cc:"ph", name:"Філіппіни"},
  VA: {cc:"in", name:"Індія"},
  VC: {cc:"lk", name:"Шрі-Ланка"},
  VD: {cc:"kh", name:"Камбоджа"},
  VE: {cc:"in", name:"Індія"},
  VG: {cc:"bd", name:"Бангладеш"},
  VH: {cc:"hk", name:"Гонконг"},
  VI: {cc:"in", name:"Індія"},
  VL: {cc:"la", name:"Лаос"},
  VM: {cc:"mo", name:"Макао"},
  VN: {cc:"np", name:"Непал"},
  VO: {cc:"in", name:"Індія"},
  VQ: {cc:"bt", name:"Бутан"},
  VR: {cc:"mv", name:"Мальдіви"},
  VT: {cc:"th", name:"Таїланд"},
  VV: {cc:"vn", name:"Вʼєтнам"},
  VY: {cc:"mm", name:"Мʼянма"},
  WA: {cc:"id", name:"Індонезія"},
  WB: {cc:"my", name:"Малайзія"},
  WI: {cc:"id", name:"Індонезія"},
  WM: {cc:"my", name:"Малайзія"},
  WN: {cc:"id", name:"Індонезія"},
  WP: {cc:"tl", name:"Східний Тимор"},
  WR: {cc:"id", name:"Індонезія"},
  WS: {cc:"sg", name:"Сінгапур"},
  ZB: {cc:"cn", name:"Китай"},
  ZG: {cc:"cn", name:"Китай"},
  ZH: {cc:"cn", name:"Китай"},
  ZJ: {cc:"cn", name:"Китай"},
  ...
  // Oceania
  AG: {cc:"sb", name:"Соломонові Острови"},
  AN: {cc:"nr", name:"Науру"},
  AY: {cc:"pg", name:"Папуа Нова Гвінея"},
  NC: {cc:"ck", name:"Острови Кука"},
  NF: {cc:"fj", name:"Фіджі"},
  NG: {cc:"ki", name:"Кірибаті"},
  NI: {cc:"nu", name:"Ніуе"},
  NL: {cc:"wf", name:"Волліс і Футуна"},
  NS: {cc:"ws", name:"Самоа"},
  NV: {cc:"vu", name:"Вануату"},
  NW: {cc:"nc", name:"Нова Каледонія"},
